...
namespace margelo::nitro::spotifysdk {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/spotifysdk/RepeatMode;";
  ...
  public:
    ...
    static jni::alias_ref<JRepeatMode> fromCpp(RepeatMode value) {
      ...
      static const auto fieldCONTEXT = clazz->getStaticField<JRepeatMode>("CONTEXT");
      ...
      switch (value) {
        ...
        case RepeatMode::CONTEXT:
          return clazz->getStaticFieldValue(fieldCONTEXT);
        default:
